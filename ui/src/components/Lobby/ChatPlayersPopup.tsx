...
export default function ChatPlayersPopup({
  players,
  banneds,
  isOpen,
  selected,
  ...
  removePlayer,
  onClose,
}: ChatPlayersPopupProps) {
  if (!isOpen || !players || !banneds || !select || !removePlayer || !unban)
    return null;
        ...
        {isEmpty ? (
          ...
          otherPlayers.map((player, index) => (
            <div
              key={index}
              className={
                selected === player.player_id ? styles.selected : styles.player
              }
              onClick={
