...
export const RoomController = {
  createRoom(req: Request<{}, {}, CreateRoom>, res: Response) {
    ...
    try {
      ...
      return HandleResponse.serverResponse(
        ...
        400,
        false,
        RoomResponses.ROOM_CREATION_FAILED
      );
    } catch (err) {
      console.error(err);
  ...
  changeRole(
    ...
    try {
      ...
      if (result === RoomResponses.FULL_ROOM)
        return HandleResponse.serverResponse(
          res,
          400,
          false,
  ...
  unbanPlayer(req: Request<ActionParams>, res: Response) {
    ...
    try {
      ...
      if (
        ...
        result === RoomResponses.BANNED_PLAYER_NOT_FOUND
      )
        return HandleResponse.serverResponse(res, 404, false, result);
